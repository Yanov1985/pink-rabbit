...
useSeoMeta({
  ...
  description: "Большой выбор качественных секс игрушек: для женщин, мужчин и пар. ✅ Быстрая доставка ✅ Дискретная упаковка ✅ Оригинальные товары",
  ogTitle: "Каталог секс игрушек - Pink Rabbit",
  ogDescription: "Широкий ассортимент интимных игрушек для взрослых. Качественные товары с быстрой доставкой по России.",
  ogImage: "/images/catalog-seks-igrushki.jpg",
  ogUrl: "https://pinkrabbit.ru/catalog",
  keywords: "секс игрушки, интимные товары, вибраторы, мастурбаторы, для взрослых, секс шоп",
});
